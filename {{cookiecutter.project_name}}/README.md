...
To finalize the set-up for publishing to PyPI, see [here](https://mikeweltevrede.github.io/cookiecutter-uv-plus/features/publishing/#set-up-for-pypi).
For activating the automatic documentation with MkDocs, see [here](https://mikeweltevrede.github.io/cookiecutter-uv-plus/features/mkdocs/#enabling-the-documentation-on-github).
To enable the code coverage reports, see [here](https://mikeweltevrede.github.io/cookiecutter-uv-plus/features/codecov/).
...
For more details, see [here](https://mikeweltevrede.github.io/cookiecutter-uv-plus/features/cicd/#how-to-trigger-a-release).
{%- endif %}

---

Repository initiated with [mikeweltevrede/cookiecutter-uv-plus](https://github.com/mikeweltevrede/cookiecutter-uv-plus).
